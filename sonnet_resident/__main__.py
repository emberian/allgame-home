"""Entry point: python -m sonnet_resident"""
...
from sonnet_resident import zulip_loop
from sonnet_resident.supervisor import run_supervised


def main():
    parser = argparse.ArgumentParser(description="Sonnet Tulip Resident")
    ...
    # Supervisor loop
    child_cmd = ([sys.executable, "-m", "sonnet_resident",
...
def _run_directly(args):
    ...
    from sonnet_resident.config import MENTION_ONLY_STREAMS
    ...
    if args.arrive:
        ...
        from sonnet_resident.metacog import run_metacog
